...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	{\large Full-Stack Machine Learning Engineer} % Career or current job title
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{At}{9}{\href{mailto:germandrummer92@gmail.com}{germandrummer92@gmail.com}}\\	
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Github}{9}{\href{https://github.com/germandrummer92}{github.com/germandrummer92}}\\
	\icon{Twitter}{9}{\href{https://twitter.com/@germandrummer92}{@germandrummer92}}\\
\end{minipage}
...
\begin{minipage}[t]{0.3\textwidth}
	...
	I love playing percussion/timpani in symphonic orchestras. Playing in 3+ different orchestras:
	\begin{itemize}
...
\begin{minipage}[t]{0.3\textwidth}
	...
	2017 - Orangutan Foundation International - Construction Volunteer in Pangkalan Bun, Indonesia. Helped build wooden walkways and shelters in old zoo.
\end{minipage}
\mbox{}
\vfill
